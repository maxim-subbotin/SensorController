...
class RegulatorCellView: UIView {
    ...
    func applyUI() {
        ...
        let lC2 = networkIcon.rightAnchor.constraint(equalTo: self.rightAnchor, constant: -10)
        ...
        let lC3 = btnTurnoff.rightAnchor.constraint(equalTo: networkIcon.leftAnchor, constant: -10)
        ...
        let lC4 = lblTempCurrent.rightAnchor.constraint(equalTo: btnTurnoff.leftAnchor, constant: -10)
        ...
        let lC5 = tempIcon.rightAnchor.constraint(equalTo: lblTempCurrent.leftAnchor, constant: -10)
        ...
        let lC6 = lblTemperature.rightAnchor.constraint(equalTo: tempIcon.leftAnchor, constant: -10)
        ...
        let lC7 = sunIcon.rightAnchor.constraint(equalTo: lblTemperature.leftAnchor, constant: -10)
        ...
        let lC8 = snowIcon.rightAnchor.constraint(equalTo: sunIcon.leftAnchor, constant: -10)
