...
+ (NSArray *)hostnamesForAddress:(NSString *)address {
    ...
    for (int currentIndex = 0; currentIndex < [(NSArray *)CFBridgingRelease(hostnamesRef) count]; currentIndex++) {
        [hostnames addObject:[(NSArray *)CFBridgingRelease(hostnamesRef) objectAtIndex:currentIndex]];
    }
